...
class Curve:
    ...
    def __init__(self, func, df=None, step=2**-20):
        ...
        func : function :: float -> complex
            The counterclockwise jordan curve with domain [0, 2pi).
            That means `func` must be continues and maps [0, 2pi) onto a
            counterclockwise jordan curve on complex plane.
        df : function :: float -> complex, option
            The derivative of `func` with domain [0, 2pi). Default is None.
